...
// calcResults comes from the persona's Python script (Daytona sandbox or
// local fallback); if absent, the static demo block is used.
export function personaUserMessage(personaId, question, calcResults) {
  const calc = calcResults ?? tsla[PERSONAS[personaId].calcKey];
